$(document).ready(function () {
    ...
    }), $(".dropdown-right").dropdown({alignment: "right"}), $(".button-collapse:not(.right-sidebar-button)").sideNav(), $(".button-collapse.right-sidebar-button").sideNav({edge: "right"}), $(".chat-button").sideNav({edge: "right"}), $(".chat-message-link").sideNav({
        menuWidth: 320,
        edge: "right"
    }), $(".chat-message").click(function () {
        $(".chat-message-link").click()
    }), $(".collapsible").collapsible(), $(".slider").slider({full_width: !0}), $(".left-sidebar-hover").mouseover(function () {
